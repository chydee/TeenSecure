...
object TeenSecureQuestionLists {
    ...
    val phishingLevel1Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "A cyberattack that steals personal information by tricking you"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the email by contacting her bank directly"
        ),
    ...
    val phishingLevel2Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "By including personal details they’ve gathered from other sources"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the legitimacy of the message by checking the sender's profile and contacting Facebook support"
        ),
        Question.TrueOrFalse(
    ...
    val phishingLevel3Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "Crafting highly personalized messages using detailed information about the target"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the legitimacy of the message by contacting the company directly"
        ),
        Question.TrueOrFalse(
    ...
    val baitingLevel1Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "A cyberattack where attackers use false promises to lure you into giving away personal information or infecting your computer with malware"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Ignore the message and avoid clicking the link"
        ),
        Question.TrueOrFalse(
    ...
    val baitingLevel2Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "By appearing as legitimate software updates or important-looking documents"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the legitimacy of the post by checking the official website of the software"
        ),
        Question.TrueOrFalse(
    ...
    val baitingLevel3Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "Embedding malware in seemingly harmless files"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the message by contacting her friend through another communication channel"
        ),
        Question.TrueOrFalse(
    ...
    val impersonationLevel1Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "Pretending to be someone else to gain trust and access personal information"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the profile by contacting her real friend through another communication method"
        ),
        Question.TrueOrFalse(
    ...
    val impersonationLevel2Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "They involve well-crafted messages and fake profiles that appear very convincing"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the message by contacting her cousin through another method"
        ),
        Question.TrueOrFalse(
    ...
    val impersonationLevel3Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "Extensive research on the target to create highly believable personas"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Verify the profile by contacting his friend through a different communication method"
        ),
        Question.TrueOrFalse(
    ...
    val cyberbullyingLevel1Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "Using the internet to harass, threaten, or embarrass someone"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Report the posts to Instagram and support his friend"
        ),
        Question.TrueOrFalse(
    ...
    val cyberbullyingLevel2Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "It includes group bullying and spreading harmful content across multiple platforms"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Report the accounts and the posts to the social media platforms and seek support from friends"
        ),
        Question.TrueOrFalse(
    ...
    val cyberbullyingLevel3Questions = listOf(
        Question.MultipleChoice(
            ...
            correctAnswer = "Serious and persistent harassment that causes significant emotional distress"
        ),
        Question.ScenarioBased(
            ...
            correctAnswer = "Seek help from mental health professionals and report the harassment to the platforms and authorities"
        ),
        Question.TrueOrFalse(
